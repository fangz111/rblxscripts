-- BY Samurai#3475
-- ok dont be butthurt i didn't really make it it's just a fucking remake that works the same I believe
...
slaves:FireServer(game.Players:FindFirstChild(target.Text).Character["Head"].Mesh, {Value = game.Players:FindFirstChild(target.Text).Character["Head"].Mesh})
